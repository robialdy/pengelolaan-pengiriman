			...
			<form action="" method="POST">
				<div class="card-body">
					<div class="form-group col-md-13">
						...
						<input type="text" class="form-control" id="a" name="kode_pengiriman" value="<?= $data_perbaris["kode_pengiriman"] ?>" readonly>
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							<select class="form-control <?= form_error('kategori') ? 'is-invalid' : ''; ?>" id="e" name="kategori">
